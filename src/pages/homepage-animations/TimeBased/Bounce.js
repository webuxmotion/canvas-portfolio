...
export class Bounce {
  constructor() {
    ...
    this.circlePoint = { x: 500, y: -500, z: 0 };
    this.circle = {
      steps: 20,
      radius: 100,
      objects: [],
  ...
  generatePoints(rows = 30, cols = 30) {
    return generatePoints(rows, cols);
  }

  genFramePoints() {
    const A = { x: 0, y: 0, z: 2000};
    const B = { x: 1000, y: 0, z: 2000};
    const C = { x: 1000, y: -1000, z: 2000};
    const D = { x: 0, y: -1000, z: 2000};
